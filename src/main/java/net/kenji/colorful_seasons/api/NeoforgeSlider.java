...
public class NeoforgeSlider extends AbstractSliderButton {
    public static final ResourceLocation SLIDER_LOCATION = ResourceLocation.withDefaultNamespace("textures/gui/sprites/widget/slider.png");
    ...
    private static final ResourceLocation SLIDER_HANDLE_FOCUSED =  ResourceLocation.withDefaultNamespace("widget/slider_handle_highlighted");
     ...
     */
    public NeoforgeSlider(int x, int y, int width, int height, Component prefix, Component suffix, double minValue, double maxValue, double currentValue, double stepSize, int precision, boolean drawString)
    {
     ...
     */
    public NeoforgeSlider(int x, int y, int width, int height, Component prefix, Component suffix, double minValue, double maxValue, double currentValue, boolean drawString)
    {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        ResourceLocation track = this.isHovered ? SLIDER_HIGHLIGHTED : SLIDER_SPRITE;
        guiGraphics.blitSprite(track, this.getX(), this.getY(), this.width, this.height);

        ResourceLocation handle = this.isFocused() ? SLIDER_HANDLE_FOCUSED : SLIDER_HANDLE;
        guiGraphics.blitSprite(handle,
                this.getX() + (int)(this.value * (double)(this.width - 8)),
                this.getY(), 8, this.height);

        renderScrollingString(guiGraphics, mc.font, 2,
